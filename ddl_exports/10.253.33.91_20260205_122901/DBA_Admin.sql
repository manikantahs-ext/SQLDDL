...
-- Server: 10.253.33.91
-- Database: DBA_Admin
-- Exported: 2026-02-05T12:29:05.853756
...
-- --------------------------------------------------
-- PK_UNIQUE dbo.BlitzFirst
-- --------------------------------------------------
ALTER TABLE [dbo].[BlitzFirst] ADD CONSTRAINT [PK__BlitzFir__3214EC27AC2C824F] PRIMARY KEY ([ID])
...
-- --------------------------------------------------
ALTER TABLE [dbo].[BlitzFirst_WaitStats_Categories] ADD CONSTRAINT [PK__BlitzFir__98C9ED57DE585D90] PRIMARY KEY ([WaitType])
...
-- --------------------------------------------------
-- PK_UNIQUE dbo.Blitzwho
-- --------------------------------------------------
ALTER TABLE [dbo].[Blitzwho] ADD CONSTRAINT [PK__Blitzwho__3214EC27902782BA] PRIMARY KEY ([ID])
...
-- --------------------------------------------------
-- TABLE dbo.backuphistory_30Dec23_To_28May24
-- --------------------------------------------------
CREATE TABLE [dbo].[backuphistory_30Dec23_To_28May24]
(
    [database_name] NVARCHAR(128) NULL,
    [backuptype] VARCHAR(30) NULL,
    [DeviceType] VARCHAR(25) NOT NULL,
    [backup_software] NVARCHAR(128) NULL,
    [recovery_model] NVARCHAR(60) NULL,
    [compatibility_level] TINYINT NULL,
    [ddd hh:mm:ss.mss] VARCHAR(34) NULL,
    [BackupStartDate] DATETIME NULL,
    [BackupFinishDate] DATETIME NULL,
    [LatestBackupLocation] NVARCHAR(260) NULL,
    [backup_size_gb] DECIMAL(10, 2) NULL,
    [compressed_backup_size_gb] DECIMAL(10, 2) NULL,
...
(
    ...
    [workload_group_name] NVARCHAR(128) NULL,
...
-- --------------------------------------------------
-- TABLE dbo.Logins_password_reset
-- --------------------------------------------------
CREATE TABLE [dbo].[Logins_password_reset]
(
    [LoginName] NVARCHAR(100) NULL,
    [NewPassword] NVARCHAR(50) NULL,
    [ResetDate] DATETIME NULL DEFAULT (getdate())
);
...
-- --------------------------------------------------
-- TABLE dbo.more_info_table_DBE_21
-- --------------------------------------------------
CREATE TABLE [dbo].[more_info_table_DBE_21]
(
    [more_info] NVARCHAR(2000) NULL
);
