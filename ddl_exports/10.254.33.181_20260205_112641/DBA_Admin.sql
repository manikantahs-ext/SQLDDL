-- DDL Export
-- Server: 10.254.33.181
-- Database: DBA_Admin
-- Exported: 2026-02-05T11:26:44.234417
...
-- --------------------------------------------------
ALTER TABLE [dbo].[BlitzFirst_WaitStats_Categories] ADD CONSTRAINT [PK__BlitzFir__98C9ED57B8C1B54C] PRIMARY KEY ([WaitType])
...
-- --------------------------------------------------
-- TABLE dbo.DBA_TopCPUConsumingQueries
-- --------------------------------------------------
CREATE TABLE [dbo].[DBA_TopCPUConsumingQueries]
(
    [QueryType] NVARCHAR(256) NULL,
    [DatabaseName] NVARCHAR(128) NOT NULL,
    [AverageCPU] DECIMAL(38, 4) NULL,
    [AverageCPUPerMinute] DECIMAL(38, 4) NULL,
    [TotalCPU] DECIMAL(38, 4) NULL,
    [PercentCPUByType] MONEY NULL,
    [PercentCPU] MONEY NULL,
    [AverageDuration] DECIMAL(38, 4) NULL,
    [TotalDuration] DECIMAL(38, 4) NULL,
    ...
    [AverageWrites] MONEY NULL,
    [PercentWrites] MONEY NULL,
    [PercentWritesByType] MONEY NULL,
    [WritesPerMinute] MONEY NULL,
    ...
    [LastReturnedRows] BIGINT NULL,
    [QueryText] NVARCHAR(MAX) NULL,
    [QueryPlan] XML NULL,
    [TotalWorkerTimeForType] BIGINT NULL,
    [TotalElapsedTimeForType] BIGINT NULL,
    [TotalReadsForType] BIGINT NULL,
    [TotalExecutionCountForType] BIGINT NULL,
    [TotalWritesForType] BIGINT NULL,
    ...
    [is_forced_parameterized] BIT NULL,
    [is_cursor] BIT NULL,
    [is_parallel] BIT NULL,
    [frequent_execution] BIT NULL,
    [parameter_sniffing] BIT NULL,
    [unparameterized_query] BIT NULL,
    [near_parallel] BIT NULL,
    [plan_warnings] BIT NULL,
    [plan_multiple_plans] BIT NULL,
    [long_running] BIT NULL,
    [downlevel_estimator] BIT NULL,
    [implicit_conversions] BIT NULL,
    [tempdb_spill] BIT NULL,
    [busy_loops] BIT NULL,
    [tvf_join] BIT NULL,
    [tvf_estimate] BIT NULL,
    [compile_timeout] BIT NULL,
    [compile_memory_limit_exceeded] BIT NULL,
    [warning_no_join_predicate] BIT NULL,
    [QueryPlanCost] FLOAT NULL,
    [missing_index_count] INT NULL,
    [unmatched_index_count] INT NULL,
...
-- --------------------------------------------------
-- TABLE dbo.HostConnectionsCount
-- --------------------------------------------------
...
-- --------------------------------------------------
-- TABLE dbo.jobs_2_delete
-- --------------------------------------------------
CREATE TABLE [dbo].[jobs_2_delete]
(
