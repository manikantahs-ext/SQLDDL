...
-- Exported: 2026-02-05T12:32:35.761382
...
-- --------------------------------------------------
ALTER TABLE [dbo].[ExecutionLogStorage] ADD CONSTRAINT [PK__Executio__05F5D74583F27431] PRIMARY KEY ([LogEntryId])
...
-- --------------------------------------------------
-- PROCEDURE dbo.FindKpiItemsByDataSet
-- --------------------------------------------------

CREATE PROCEDURE [dbo].[FindKpiItemsByDataSet]
...
where
    DS.[LinkID] = @DataSetID AND c.[Type] = 11 /*Kpi Data Type*/
