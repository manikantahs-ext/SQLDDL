...
-- Server: 10.254.33.21
-- Database: DBA_Admin
-- Exported: 2026-02-05T11:34:47.769159
...
-- --------------------------------------------------
ALTER TABLE [dbo].[BlitzFirst_WaitStats_Categories] ADD CONSTRAINT [PK__BlitzFir__98C9ED574EE4C84F] PRIMARY KEY ([WaitType])
...
-- --------------------------------------------------
-- TABLE dbo.akarsh_test
-- --------------------------------------------------
CREATE TABLE [dbo].[akarsh_test]
(
    [ServerName] VARCHAR(50) NULL,
    [ServerPort] VARCHAR(50) NULL,
    [DatabaseName] VARCHAR(150) NULL,
    [TableName] VARCHAR(300) NULL,
    [TableSizeinGB] BIGINT NULL,
    [DateColumns] VARCHAR(MAX) NULL,
