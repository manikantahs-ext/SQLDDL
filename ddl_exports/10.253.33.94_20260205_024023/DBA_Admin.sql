...
-- Server: 10.253.33.94
-- Database: DBA_Admin
-- Exported: 2026-02-05T02:40:26.135564
...
-- --------------------------------------------------
ALTER TABLE [dbo].[BlitzFirst_WaitStats_Categories] ADD CONSTRAINT [PK__BlitzFir__98C9ED57AA873BDC] PRIMARY KEY ([WaitType])
...
-- --------------------------------------------------
-- TABLE dbo.all_server_login_disable_info
-- --------------------------------------------------
CREATE TABLE [dbo].[all_server_login_disable_info]
(
    [collection_time] DATETIME NOT NULL DEFAULT (sysdatetime()),
    ...
    [Login_modify_date] DATETIME NULL,
    [is_expiration_checked] INT NULL,
    [DaysUntilExpiration] INT NULL,
    [is_Password_Expired] INT NULL,
    [is_Login_disabled] INT NULL,
    [password_last_set_time] DATETIME NULL,
    [Days_since_last_password_reset] INT NULL
);
...
,cte_disk_space_datasource as (select collection_time_utc, host_name, disk_volume, label, capacity_mb, free_mb, block_size, filesystem from [10.253.33.34].[DBA_Admin].dbo.disk_space)
...
,cte_os_tasks_datasource as (select [collection_time_utc], [host_name], [task_name], [pid], [session_name], [memory_kb], [status], [user_name], [cpu_time], [cpu_time_seconds], [window_title] from [10.253.33.34].[DBA_Admin].dbo.os_task_list)
...
,cte_counters_datasource as (select collection_time_utc, host_name, object, counter, value, instance from [10.253.33.34].[DBA_Admin].dbo.performance_counters)
